...
extension CGPoint
{
    ...
    /// - Parameters:
    ///   - regionStart: Top left or bottom left of the region based on coordinate system
    ///   - regionEnd: Bottom right or top left of the region based on coordinate system
